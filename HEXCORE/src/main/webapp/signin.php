    ...
    <div class="w-full max-w-[460px] relative group/card">
        ...
        <div class="bg-surface-dark border border-border-dark p-8 md:p-10 shadow-2xl backdrop-blur-sm relative overflow-hidden clip-corner-br">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold tracking-tighter text-white mb-2">SYSTEM ACCESS</h1>
                <div class="flex items-center justify-center gap-2">
                    <span class="w-1.5 h-1.5 bg-primary rounded-full animate-pulse"></span>
                    <p class="text-gray-400 text-sm tracking-widest uppercase">Enter the mainframe</p>
                    <span class="w-1.5 h-1.5 bg-primary rounded-full animate-pulse"></span>
                </div>
            </div>
            <!-- Form -->
            <form class="flex flex-col gap-6">
                ...
                <div class="space-y-2 group/input">
                    ...
                    <div class="relative flex items-center input-focus-ring transition-all duration-300 bg-[#0f0f0f] border border-[#2a2a2a] rounded overflow-hidden">
                        ...
                        <input class="w-full bg-transparent border-none text-white placeholder-gray-600 focus:ring-0 h-12 px-3 text-sm font-medium tracking-wide"
                               placeholder="USER_EMAIL" type="email" id="email"/>
                ...
                <div class="space-y-2 group/input">
                    <div class="flex justify-between items-end">
                        <label class="text-xs font-bold text-gray-500 tracking-wider ml-1 group-focus-within/input:text-primary transition-colors">PASSCODE</label>
                    </div>
                    <div class="relative flex items-center input-focus-ring transition-all duration-300 bg-[#0f0f0f] border border-[#2a2a2a] rounded overflow-hidden">
                        <span class="pl-4 text-gray-500 material-symbols-outlined text-[20px]">lock</span>
                        <input class="w-full bg-transparent border-none text-white placeholder-gray-600 focus:ring-0 h-12 px-3 text-sm font-medium tracking-wide"
                               placeholder="••••••••••••" type="password" id="password"/>
                        <button class="pr-3 text-gray-600 hover:text-white transition-colors focus:outline-none flex items-center"
                                type="button">
                ...
                <div class="flex items-center justify-between text-sm mt-1">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <div class="relative">
                            ...
                            <div class="w-9 h-5 bg-[#2a2a2a] rounded-full peer-checked:bg-primary/20 transition-all border border-transparent peer-checked:border-primary/50"></div>
                            <div class="absolute top-[2px] left-[2px] bg-gray-500 w-4 h-4 rounded-full transition-all peer-checked:translate-x-4 peer-checked:bg-primary shadow-sm"></div>
                        </div>
                        <span class="text-gray-400 group-hover:text-white transition-colors text-xs font-medium tracking-wide">REMEMBER ME</span>
                    </label>
                    <a class="text-primary hover:text-white hover:underline decoration-primary transition-all text-xs font-bold tracking-wide"
                       href="fogot_password.php">RESET CREDENTIALS</a>
                </div>
                <!-- Submit Button -->
                <button onclick="signin();"
                        class="relative w-full h-12 mt-4 bg-primary text-white font-bold tracking-[0.15em] text-sm uppercase overflow-hidden group/btn hover:shadow-glow hover:-translate-y-0.5 transition-all duration-300 rounded clip-corner-br">
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-500 text-sm">New unit detected? <a
                        class="text-white font-bold hover:text-primary transition-colors ml-1 underline decoration-primary/50 hover:decoration-primary"
                        href="#">CREATE ID</a></p>
        </div>
    </div>
</main>
...
<footer class="relative z-10 w-full py-4 text-center border-t border-[#1a1a1a] bg-black/40 backdrop-blur-md">
    <div class="flex items-center justify-center gap-6 text-[10px] uppercase tracking-widest text-gray-600 font-medium">
        <span class="flex items-center gap-1.5"><span
                    class="size-1.5 rounded-full bg-emerald-500 shadow-[0_0_5px_rgba(16,185,129,0.5)]"></span> Server Online</span>
